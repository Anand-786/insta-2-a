...
function Modal() {
    ...
    const uploadPost = async () => {
        ...
        //get a download url to firebase storage and update the original post with image
        ...
        <Dialog as='div' className='fixed z-10 inset-0 overflow-y-auto' onClose={setOpen}>
            ...
            text-center sm:block sm:p-0'>
                ...
                leaveTo='opacity-0'>
                    ...
                    transition-opacity"></Dialog.Overlay>
                </Transition.Child>
                        ...
                        <div>
                            ...
                            <div>
                                <div className='mt-3 text-center sm:mt-5'>
                                    ...
                                    <div className='mt-2'>
                                        <input ref={captionRef} className='border-none focus:ring-0 w-full text-center'
                                        type="text"
                            ...
                            <div className='mt-5 sm:mt-6'>
                                ...
                                justify-center w-full rounded-md border border-transparent shadow-sm 
